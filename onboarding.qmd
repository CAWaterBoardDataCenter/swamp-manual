...
-   If you are new to the state and select **vacation/sick leave**, you will accrue but not be able to use vacation leave for the first 6 months of continuous, full-time work after your hire date.

-   Other classifications of leave are available regardless of the leave type you select, including some granted at the beginning of every fiscal year (July 1). For more information, see [section 2100](https://hrmanual.calhr.ca.gov/Home/ManualItem/1/2101) of the CalHR manual.
...
Staff should complete and submit their timesheets by the 25th of each month. Direct deposit typically hits the last day of the pay period (end of the month), potentially earlier if you use a credit union like Golden 1.
...
Your typical work schedule (Work Week Agreement) and Telework Plan need to be created in BizFlow within 2 months of starting work. If you are interested in an alternate work week schedule, which allows a non-exempt employee to work a fixed schedule other than 5 days per week, 8 hours per day, inquire with your supervisor. Alternate work week [details](https://hrmanual.calhr.ca.gov/Home/ManualItem/1/1503) and [annual schedules](https://www.calhr.ca.gov/Pages/publications-awws-calendars.aspx) are available in the CalHR manual.

The Telework Policy for CalEPA and the Water Boards allows remote-centered work options for all staff as long as business needs can be met. As of January 2023, OIMA still maintains enough office space that staff will be assigned a cubicle or personal workstation in the CalEPA building whether or not they primarily work remotely.

### Bizflow: Telework Agreement

**Logging in**: To [login](https://ework.waterboards.ca.gov/bizflow/index.jsp?v=_5FtHCSz6JfUxrK7) you must use MS Edge browser and be connected to VPN (or on the network at CalEPA building). Use your workstation username (waterboards email address) and password to login.

### Bizflow: Work Week Agreement
...
Equipment available to take home includes: laptop, laptop bag, standard monitor, keyboard, mouse, headset, adjustable monitor stand, adjustable tilting laptop stand. To request additional equipment or to report issues with any of your equipment, send an email to the [IT Help Desk](mailto:help@waterboards.ca.gov). This will log a ticket in their tracking system and they will respond typically the same day. Ergonomic equipment may be made available through a [Reasonable Accommodation Request](https://waternet.waterboards.ca.gov/eeo/reasonable/index.shtml) (intranet link requires VPN login). Work with your supervisor for guidance on preparing the request.
