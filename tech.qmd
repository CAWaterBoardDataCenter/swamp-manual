...
See the [Onboarding Chapter](https://cawaterboarddatacenter.github.io/swamp-manual/onboarding.html#telework-equipment) for how to obtain your work computer & hardware. Your supervisor will help you with this process.

## Remote desktop vs. VPN

Remote desktop and Virtual Private Network (VPN) enable staff to securely connect to the Water Board's network.

-   VPN is used on Water Boards' approved devices to access the network when working remotely.
...
Your supervisor and DIT will help you get set up.
