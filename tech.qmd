...
See the [Onboarding chapter](https://cawaterboarddatacenter.github.io/swamp-manual/onboarding.html#equipment) for how to obtain your work computer & hardware. Your supervisor will help you with this process.

## Virtual Desktop vs. VPN

If you are working remotely and need to access files on your personal network drive (H:) or a shared network drive (S:, R:) drive, you will need to safely connect to the Water Boards network via Virtual Desktop or virtual private network.

**Virtual desktop** is... \[*work in progress*\]

**Virtual private network (VPN)** is a mechanism for creating a secure connection between a device (such as your computer) and a computer network. The Water Boards uses the Global Protect VPN Client, which should be installed on your State-issued computer already. It can be found under the "Palo Alto Networks" folder in the Windows start menu. If you do not see it installed, contact the DIT Help Desk (help\@waterboards.ca.gov). Follow the step-by-step guide below for logging into the client.

-   [How to Connect to Global Protect VPN Client](https://waternet.waterboards.ca.gov/dit/help_desk/docs/vpn_user_instructions.pdf) (*If you cannot access this document, reach out to a coworker and ask if they can send you a copy.*)

## Multi-Factor Authentification

Multi-Factor Authentification is required when accessing the Water Boards network through VPN, Virtual Desktop, or Office 365. Using the **Microsoft Authenticator app** is the quickest and easiest way to complete the login and verification process. Using this method requires that you download and install the Microsoft Authenticator app on your phone and tablet.

-   [Multi-Factor Authentication (MFA) User Setup Guide](https://waternet.waterboards.ca.gov/dit/help_desk/docs/mfa_user_setup_guide.pdf) (*If you cannot access this document, reach out to a coworker and ask if they can send you a copy.*)

If you cannot or do not want to use the Microsoft Authenticator app, contact the DIT Help Desk (help\@waterboards.ca.gov) to request a Physical Token that can be used instead of the app.
...
Also see this [Business Intelligence Handbook](https://www.waterboards.ca.gov/resources/oima/cowi/business_intelligence_handbook.html) for guidance on buisness intelligence tools (i.e., software) that are available to Water Boards staff.
...
-   Getting access to the OIMA Zoom Account (or requesting a meeting)
