...
-   [College of Water Informatics (CoWI) Data Tool Kit](https://www.waterboards.ca.gov/resources/oima/cowi/data_training.html)
    -   This site includes a list of [free resources](https://www.waterboards.ca.gov/resources/oima/cowi/data_training.html#data_science) on topics that are particularly relevant for OIMA folks like data science, data analysis and visualizations, programming languages, and ESRI ArcGIS
-   The EPA Watershed Academy is a nice hub where you can find learning modules, webinars, and other watershed resources
    -   For example, here's one useful module they put together: "[Clean Water Act through an Environmental Justice Lens](https://www.epa.gov/watershedacademy/clean-water-act-through-environmental-justice-lens-module)"
